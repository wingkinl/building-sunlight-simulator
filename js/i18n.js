    ...
    const translations = {
        zh: {
            ...
            viewer: {
                ...
                exportAnalysisSaveCanceled: '已取消保存文件',
                exportAnalysisSaveFailed: '保存文件失败，请重试',
        ...
        en: {
            ...
            viewer: {
                ...
                exportAnalysisSaveCanceled: 'Save canceled',
                exportAnalysisSaveFailed: 'Failed to save file, please try again',
